...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Bachelor of Science in Computing and Law;  GPA: 3.42/4.0}{Aug. 2023 -- Aug. 2026}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Flutter}
          {Collaborative development of Yap.com website and mobile app with Flutter SDK.}
        \resumeItem{Figma}
...
\section{Programming Skills}
 \resumeSubHeadingListStart
   \resumeSubItem{Languages}
      {Python, Javascript, Typescript, PHP, SQL, Rust, Dart, Java, Lua, Ruby, C\#}
   \resumeSubItem{Technologies}
      {Svelte, Flutter, Express, Tauri, Ruby on Rails, Laravel}
 \resumeSubHeadingListEnd
